...
//            if (iterator == 5){
//                payment += 2000;
//                System.out.println("Paid 2000 more from annual bonus");
//            }
//            else if (iterator == 17){
//                payment += 0;
//            }
...
//        }
    ...
    public static double InterestAdded(double principal, double APR, int numDays){
    ...
    public static double calcMonthlyBalance(double Principal, int year, int month, int date, double apr, int payment, int iterator){
        Calendar calendar = Calendar.getInstance();
        calendar.set(year,month,date);
